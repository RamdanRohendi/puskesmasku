...
<div class="card mx-3 shadow mt-4 min-vh-admin">
    <div class="card-header d-flex justify-content-between">
        <h1>Data Pengguna</h1>
        <a href="<?= base_url().'/admin/pengguna-form.php' ?>" class="btn btn-info text-light my-2">Tambah Data</a>
    </div>
    <div class="card-body">
        <div class="container">
            <div class="row">
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-nowrap">
                                <a class="btn btn-sm btn-warning" href="<?= base_url().'/admin/pengguna-form.php?id='.$data['id'] ?>">Ubah</a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a class="btn btn-danger" href="<?= base_url().'/controllers/penggunaController.php?hapus=true&id='.$data['id'] ?>">Yakin</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    function refreshPage(page = 1) {
        ...
        window.location.replace(`<?= base_url() ?>/admin/pengguna.php?search=${search}&limit=${limit}&page=${page}`);
    }
